...
function OccurrenceForm({ occurrence, data, onDone, onCancel }: { occurrence: FinancialOccurrence; data: ReturnType<typeof useItems>; onDone: () => void; onCancel: () => void }) {
  ...
  return <View style={styles.form}>
    ...
    {possibleDuplicate ? <View accessibilityRole="alert" style={styles.warning}><Feather name="alert-triangle" size={16} color={colors.mustard} /><Text style={styles.warningText}>A similar transaction already exists on this date. Mewmo will ask before saving another.</Text></View> : null}
