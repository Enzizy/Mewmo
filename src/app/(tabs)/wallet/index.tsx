...
export default function WalletScreen() {
  ...
  return (
    <AppScreen assistant={!editingStartingPoint}>
...
const styles = StyleSheet.create({
  ...
  safeCard: { minHeight: 82, marginTop: 12, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 11, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.paper },
  ...
  safeDetail: { marginTop: 2, fontFamily: fonts.body, fontSize: 10, lineHeight: 14, color: colors.secondary },
  safeValue: { maxWidth: '28%', fontFamily: fonts.bodyBold, fontSize: 14, fontVariant: ['tabular-nums'], color: colors.ink },
